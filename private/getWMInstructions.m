function [newInstructions,betweenInstructions,endStructions] = getWMInstructions(keys,block,totalblock)
  ...
  %
    ...
    newInstructions = { ...
        ...
        'You will be paying attention to circles on one side of the screen \n\n',...
        'and you will be asked to remember whether they change colors or not. \n',...
        ], ...
        [...
         'To play this game,\n\n'...
        ...
        'Remember the colors on the side of the screen that the arrow was pointing to. \n', ...
         ], ...
         @(w) arrowanddots(w,1,[15;10], [2;4]),...
        ['The circles will disappear, a yellow cross will appear, and then \n\n'...
        'new circles will appear in the same locations.\n'], ...
        {@(w) drawWMArrow(w,1), ...
        },...
        ...
        'If you do not see a yellow cross after seeing the circles, forget the colors\n\n',...
        'and get ready to memorize the colors of new circles.'...
        ], ...
        @(w) fullTrial(w,1,[12;8], [1;4], [3;4],keys{2},1 ), ... catch before dly
        [...
        'Also, if there are no dots after a yellow cross\n\n',...
        'forget the colors and get ready to memorize the colors of new circles.'...
        ], ...
    ...
    function fullTrial(w,dir,pos,col,col2,key,varargin)
        ...
        if ~isempty(varargin) && varargin{1}==1
            catchtrialend(w,['There was not a yellow cross.\n\n\n',...
                'Forget those colors and get ready for new colors']);
            return
        end
