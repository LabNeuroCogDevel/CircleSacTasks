function [newInstructions,betweenInstructions,endStructions] = getWMInstructions(keys,block,totalblock)
  ...
  %
    ...
    newInstructions = { ...
        ...
        ['These circles will then disappear, a yellow cross will appear, and then \n'...
        ...
        'If you do not see a yellow cross after seeing the dots, forget the colors\n',...
        ...
        'forget the colors and get ready to memorize the colors of new dots.'...
        ], ...
