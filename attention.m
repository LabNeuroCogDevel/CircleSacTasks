...
function subject = attention(varargin)
   ...
   global TIMES listenKeys CUMULATIVE modality filelist shrinkVal;
   % TIMES, CLEARTIME, and shrinkVal set in 
   ATTsettings();
   ...
   PrdgmStruct.practicefMRI ={ 13, 1,@(x,y,varargin) readAttentionEvents(x,y,'timing/att.prac.txt',varargin)};
