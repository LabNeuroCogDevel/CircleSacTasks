...
function subject = attention(varargin)
   ...
   elseif strcmp(modality,'MEG')   
    ...
    newInstructions = { 'Welcome to the Attention Game!\n', ...
                        ...
                        'Step 3\nThe rings will open up.\n There will all be missing part of the left or right side.\n The target direction is what side of the target ring is open.\n',...
                        'Step 4\n\n Push the left index finger if the target direction is left\n\nPush your right index finger if right is the target direction.', ....
